 ...
 * 
 * Each method takes {@link BatchOperation} object as an argument
 * and returns {@link BatchOperationResult}
 * 
 */
...
/**
 * Deletes from all rows defined by {@link Scan} object in BatchOperation argument.
 * Columns to delete are defined in list of {@link BatchOperation.Value} objects
 * @param delete
 * @return
 * @throws IOException
 */
